...
class GetCampaigns {
    ...
    const CUSTOMER_ID = '8223589907';
    const PAGE_SIZE = 1000;

    public static function main($customer_id = null) {
        ...
        try {
            $results = self::runExample($googleAdsClient, $customer_id);
...
die();
$customer_id = "8223589907";
$campaigns = GetCampaigns::main($customer_id);
return $campaigns;
